...
public class Robot implements PlayerActions  {

    //свойства класса
    private String name;
    private double max_jump_height = 1;
    private int max_run_distance = 50;
    ...
    @Override
    public void runInfo() {
        System.out.println("Этот робот умеет бегать");
    }

    @Override
    public void jumpInfo() {
        System.out.println("Этот робот умеет прыгать");
    }
